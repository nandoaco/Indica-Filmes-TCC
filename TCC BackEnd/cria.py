...
filmes = [
   (1, 'Central do Brasil', 'CentralDoBrasil.jpg','''Dora, uma amargurada ex-professora, ganha a vida escrevendo cartas para pessoas analfabetas, 
   ...
   (2, 'Bicho de sete cabeças', 'Bicho.jpg', '''O relacionamento entre Wilson e seu filho Neto está cada vez pior. 
   ...
   (3, 'O Auto da compadecida', 'OAutoDaCompadecida.jpg', '''As aventuras de João Grilo e Chicó, dois nordestinos pobres que vivem de golpes para sobreviver. 
   ...
   (5, 'Malasarte e o duelo contra a morte', 'Malasarte.jpg', '''O jovem Pedro Malasartes é um malandro que viaja de cidade em cidade pregando peças em estranhos desavisados e ingênuos,
